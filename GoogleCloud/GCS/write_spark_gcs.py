...
# 1. Repartition the data frame to 1.
# 2. Write the data frame to the GCS bucket.
# 3. Get the key inside the GCS bucket at the output path with the prefix part
# 4. Rename the part file
